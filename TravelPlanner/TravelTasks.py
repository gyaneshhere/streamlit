...
#from agents import location_expert, guide_expert, planner_expert DuckDuckGoSearchRunTool DuckDuckGoSearchResults DuckDuckGoSearchRun
...
class TravelTasks():
    ...
    def location_task(self, agent, from_city, destination_city, date_from, date_to):
        return Task(
            ...
            Follow this rules : 
            1. if the {destination_city} is in America : Respond in ENGLISH.
            """,
            expected_output=f"""
            if the {destination_city} is in America : Respond in ENGLISH.
